...
export const metadata: Metadata = {
  ...
  description: "Find what your business is losing. Fix it. Track your progress. Fruxal gives Canadian SMBs AI-powered financial diagnostics, leak detection, and a personalized action plan — free forever.",
  ...
  openGraph: {
    ...
    description: "AI-powered financial diagnostics for Canadian small businesses. Find leaks, fix them, track your recovery. Free forever.",
    url: "https://fruxal.ca",
    siteName: "Fruxal",
    type: "website",
    locale: "en_CA",
  ...
  twitter: {
    ...
    title: "Fruxal — Free Financial Diagnostics for Canadian SMBs",
    description: "AI-powered financial diagnostics for Canadian small businesses. Free forever.",
  },
  icons: {
