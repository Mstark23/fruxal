          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <div className="text-2xl font-bold text-white tracking-tight">
                ${s.totalEstimatedLow.toLocaleString()} <span className="text-[#4a5578] font-normal">–</span> ${s.totalEstimatedHigh.toLocaleString()}
              </div>
            ...
            <div>
              ...
              <div className="text-2xl font-bold text-white tracking-tight">
                ${s.feeRangeLow.toLocaleString()} <span className="text-[#4a5578] font-normal">–</span> ${s.feeRangeHigh.toLocaleString()}
              </div>
                ...
                <div className="px-5 py-4 flex items-center gap-4">
                  ...
                  <div className="text-right shrink-0">
                    <div className="text-sm font-bold text-white tabular-nums">
                      ${leak.estimatedLow.toLocaleString()} – ${leak.estimatedHigh.toLocaleString()}
                    </div>
                          ...
                          <ul className="space-y-1">
                            {leak.dataNeeded.map((d, i) => (
                              <li key={i} className="text-xs text-[#6b7694] flex items-start gap-2">
                                <span className="w-1 h-1 rounded-full bg-[#2a3552] mt-1.5 shrink-0" />
                                {d}
                              </li>
                            ))}
                          </ul>
