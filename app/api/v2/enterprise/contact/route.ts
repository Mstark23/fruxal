...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { company, name, email, phone, revenue, industry, province, country, message, lang } = body;
