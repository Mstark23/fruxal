...
export async function GET(req: NextRequest) {
  try {
    ...
    const baseUrl   = process.env.NEXTAUTH_URL || process.env.NEXT_PUBLIC_APP_URL || "https://fruxal.vercel.app";
...
<div class="pg">
  ...
  <div class="ft">
    <p>Generated by <a href="${baseUrl}" style="color:#1B4D3E">Fruxal</a> · fruxal.vercel.app</p>
