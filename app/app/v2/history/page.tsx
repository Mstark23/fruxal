...
const TIMELINE_ICONS: Record<string, JSX.Element> = {
  scan: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>,
  done: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polyline points="20 6 9 17 4 12"/></svg>,
  leak: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><path d="M12 2.69l5.66 5.66a8 8 0 11-11.31 0z"/></svg>,
  default: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><circle cx="12" cy="12" r="10"/></svg>,
};
    ...
    return (
      <div className="rounded-xl border p-3 mb-2"
        ...
        <div className="flex items-start gap-2">
          <span className="shrink-0 mt-0.5" style={{color:"var(--color-brand)"}}>{ TIMELINE_ICONS[event.icon] ?? TIMELINE_ICONS.default }</span>
  ...
  if (events.length === 0) {
    return (
      <div className="p-6 text-center">
        <svg className="w-10 h-10 mx-auto mb-4 text-ink-muted" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-4 4"/></svg>
