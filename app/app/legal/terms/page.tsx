...
export default function TermsPage() {
  return (
    <div>
      ...
      <P>Paid plans are billed monthly in Canadian dollars through Stripe. Current pricing is displayed at fruxal.ca/pricing. By subscribing, you authorize Fruxal to charge your payment method on a recurring monthly basis until you cancel.</P>
