  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] bg-[#FAFAF8]">
      <div className="text-center max-w-md px-6">
        ...
        <p className="text-[13px] text-[#8E8C85] mb-6 leading-relaxed">
          {error.message || "An unexpected error occurred. Please try again."}
        </p>
        <div className="flex gap-3 justify-center">
          <button
            onClick={reset}
            className="bg-[#1B3A2D] text-white font-semibold px-6 py-2.5 rounded-xl hover:bg-[#2A5A44] transition text-[13px]"
          >
            Try Again
          </button>
          <a
            href="/v2/dashboard"
            className="bg-white border border-[#E5E3DD] text-[#56554F] font-semibold px-6 py-2.5 rounded-xl hover:bg-[#F0EFEB] transition text-[13px]"
          >
            Back to Dashboard
          </a>
        </div>
