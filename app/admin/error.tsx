    ...
    <div className="flex items-center justify-center min-h-[60vh] bg-[#FAFAF8]">
      <div className="text-center max-w-md px-6">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <a href="/admin/overview" className="bg-white border border-[#E5E3DD] text-[#56554F] font-semibold px-6 py-2.5 rounded-xl hover:bg-[#F0EFEB] transition text-[13px]">Back to Admin</a>
        </div>
      </div>
    </div>
  );
