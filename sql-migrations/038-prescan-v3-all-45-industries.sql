...
ON CONFLICT (id) DO UPDATE SET
  ...
  loss_type=EXCLUDED.loss_type, loss_pct_low=EXCLUDED.loss_pct_low,
  loss_pct_high=EXCLUDED.loss_pct_high, loss_fixed_low=EXCLUDED.loss_fixed_low,
  loss_fixed_high=EXCLUDED.loss_fixed_high, loss_per_employee=EXCLUDED.loss_per_employee,
  impact_statement=EXCLUDED.impact_statement, fix_description=EXCLUDED.fix_description,
  affiliate_category=EXCLUDED.affiliate_category, updated_at=NOW();
INSERT INTO industry_leak_patterns 
  (id, industry, leak_category, detector_id, title, description, probability_pct, severity,
   loss_type, loss_pct_low, loss_pct_high, loss_fixed_low, loss_fixed_high, loss_per_employee,
   impact_statement, evidence_line, fix_description, affiliate_category, display_order)
