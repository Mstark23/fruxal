...
-- ─── 8. SUBSCRIPTIONS (Update existing or create) ───────────────────────────
-- Add monitoring_enabled column if not exists
ALTER TABLE subscriptions ADD COLUMN IF NOT EXISTS monitoring_enabled BOOLEAN DEFAULT false;
...
-- ─── 10. BUSINESS_USERS (Multi-user access) ─────────────────────────────────
...
-- ─── 11. SAVINGS EVENTS (Recovery Tracking) ─────────────────────────────────
